...
public class CalendarioView extends JPanel {
    ...
    public CalendarioView() {
        ...
        agregarCampo(formularioPanel, gbc, "Fecha", fechaField = new JTextField(20), 1);
        agregarCampo(formularioPanel, gbc, "Evento", eventoField = new JTextField(20), 2);
        agregarCampo(formularioPanel, gbc, "Descripción", descripcionField = new JTextField(20), 3);
        ...
        // Tabla
        modeloTabla = new DefaultTableModel(new Object[]{"ID", "Fecha", "Evento", "Descripción"}, 0) {
            @Override
        ...
        tablaEventos.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (fila >= 0) {
                    idField.setText(tablaEventos.getValueAt(fila, 0).toString());
                    fechaField.setText(tablaEventos.getValueAt(fila, 1).toString());
                    eventoField.setText(tablaEventos.getValueAt(fila, 2).toString());
                    descripcionField.setText(tablaEventos.getValueAt(fila, 3).toString());
                }
            }
        });
